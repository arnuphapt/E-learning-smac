export const DATA = {
  courses: [
    {
      ...
      progress: 62,
      hero: "#0d6e8c",
      access: { allowedYears: ["66"], allowedEmails: [] },
    },
    {
      id: "c2",
      code: "NUR302",
      ...
      progress: 35,
      hero: "#1e5fa8",
      access: { allowedYears: ["66", "67"], allowedEmails: ["specialstudent@smnc.ac.th"] },
    },
    {
      id: "c3",
      code: "NUR315",
      ...
      progress: 0,
      hero: "#2f7d5b",
      access: { allowedYears: ["65"], allowedEmails: [] },
    },
    {
      id: "c4",
      code: "NUR210",
      ...
      progress: 100,
      hero: "#5b4b9e",
      access: { allowedYears: ["67"], allowedEmails: [] },
    },
  ],
  ...
  assignments: [
    ...
    {
      id: "a2", lessonId: "l2", courseId: "c1",
      title: "ใบงานที่ 2 — การเฝ้าระวังผู้ป่วยกล้ามเนื้อหัวใจตายเฉียบพลัน",
      due: "28 มิ.ย. 2568 23:59 น.",
      dueShort: "28 มิ.ย.",
      points: 20,
      instructions:
        "วิเคราะห์ EKG Strip ของผู้ป่วยที่มีภาวะ Acute MI และเขียนแผนการพยาบาลระยะวิกฤต 2 แผนพยาบาลพร้อมระบุภาวะแทรกซ้อนที่ต้องเฝ้าระวังอย่างใกล้ชิด",
      attachments: [
        { name: "ใบงานที่2_EKG_MI.pdf", size: "450 KB" },
      ],
      rubricId: "r1",
      allowText: true, allowFile: true,
    },
    {
      id: "a3", lessonId: "l4", courseId: "c1",
      title: "ใบงานที่ 3 — การประเมินและการวิเคราะห์แนวทางใช้เครื่องช่วยหายใจ",
      due: "15 มิ.ย. 2568 23:59 น.",
      dueShort: "15 มิ.ย.",
      points: 20,
      instructions:
        "ให้นักศึกษาตอบคำถามเกี่ยวกับโหมดของเครื่องช่วยหายใจ (Ventilator Mode) และอธิบายการพยาบาลเพื่อป้องกัน VAP (Ventilator-Associated Pneumonia) ตามหลักฐานเชิงประจักษ์ล่าสุด",
      attachments: [
        { name: "ใบงานที่3_Ventilator.docx", size: "90 KB" },
      ],
      rubricId: "r1",
      allowText: true, allowFile: true,
    },
